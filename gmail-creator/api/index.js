...
const getRandomUser = () => new Promise(async (resolve, reject) => {
    try {
...
const getSimPhone = ({ country, operator, product }) => new Promise(async (resolve, reject) => {
    try {
...
const checkSimActivation = ({ sim_id }) => new Promise(async (resolve, reject) => {
    try {
...
export { getRandomUser, getSimPhone, checkSimActivation }